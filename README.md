## openni2_camera (rolling) - 2.3.0-1

The packages in the `openni2_camera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release openni2_camera -t rolling -r rolling` on `Wed, 21 May 2025 12:28:00 -0000`
...
## openni2_camera (rolling) - 2.2.2-1

The packages in the `openni2_camera` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling -t rolling openni2_camera` on `Sun, 03 Nov 2024 14:29:47 -0000`
...
The packages in the `openni2_camera` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy -t jazzy openni2_camera` on `Sun, 03 Nov 2024 14:28:19 -0000`
